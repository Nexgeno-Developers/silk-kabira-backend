                ...
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <form class="row g-3 align-items-center">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" value="{{request()->get('search')}}" placeholder="Search by name or email">
                            </div>
                            <div class="col-md-1">
                    ...
                    <div class="col-md-3 text-end">
                        <button onclick="smallModal('{{url(route($routeName . '.create'))}}', 'Add New')" class="btn btn-primary btn-icon w-100"><i class="ti ti-plus"></i> Add New</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" onclick="confirmModal('{{ route($routeName . '.destroy', $row->id) }}', callbackAuthors )" class="link-reset fs-20 p-1"> <i class="ti ti-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<script defer>
const callbackAuthors = function(response) {
    setTimeout(function() {
        location.reload();
    }, 1500);
}
